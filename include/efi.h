...
struct __attribute__((packed)) EFI_INPUT_KEY {
...
struct __attribute__((packed)) EFI_DEVICE_PATH_PROTOCOL {
	unsigned char Type;
...
struct __attribute__((packed)) EFI_GRAPHICS_OUTPUT_BLT_PIXEL {
	unsigned char Blue;
	unsigned char Green;
	unsigned char Red;
...
struct __attribute__((packed)) EFI_GRAPHICS_OUTPUT_PROTOCOL {
...
struct __attribute__((packed)) EFI_SIMPLE_POINTER_STATE {
...
struct __attribute__((packed)) EFI_SIMPLE_POINTER_PROTOCOL {
...
struct __attribute__((packed)) EFI_TIME {
...
struct __attribute__((packed)) EFI_FILE_INFO {
	unsigned long long Size;
...
struct __attribute__((packed)) EFI_KEY_STATE {
	unsigned int KeyShiftState;
	unsigned char KeyToggleState;
};

struct __attribute__((packed)) EFI_KEY_DATA {
	struct EFI_INPUT_KEY Key;
	struct EFI_KEY_STATE KeyState;
};

struct __attribute__((packed)) EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL {
	unsigned long long (*Reset)(
...
struct __attribute__((packed)) EFI_LOADED_IMAGE_PROTOCOL {
...
struct __attribute__((packed)) EFI_DEVICE_PATH_TO_TEXT_PROTOCOL {
	unsigned long long _buf;
...
struct __attribute__((packed)) EFI_DEVICE_PATH_FROM_TEXT_PROTOCOL {
...
struct __attribute__((packed)) EFI_DEVICE_PATH_UTILITIES_PROTOCOL {
	unsigned long long _buf[3];
